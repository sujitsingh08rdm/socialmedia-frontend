  ...
  return (
    <div className="bg-primary min-h-screen flex flex-col items-center gap-6 pt-10">
      ...
      <div className="flex flex-col items-center text-center">
        <h1 className="text-4xl font-black text-black neo-card bg-accent-1 inline-block">
          Welcome To bingeHub
        </h1>

        <p className="mt-4 text-black font-medium neo-card bg-accent-2 inline-block">
